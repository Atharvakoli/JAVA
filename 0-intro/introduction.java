...
C Was powerful efficient and structured language - still the problem was complexity-December 1989
...
Inherited class have to define only its own unique properties within the class
...
2. Identifiers
Classnames, method names and variables names Can contain descriptive sequence of uppercase letters, lowercase letter, numbers or underscores and doller sign characters Must not begin with number case sensitive
